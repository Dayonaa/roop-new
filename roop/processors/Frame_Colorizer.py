    ...
    def Initialize(self, plugin_options:dict):
        ...
        if self.model_colorizer is None:
            ...
            if self.prev_type == "deoldify_artistic":
                model_path = resolve_relative_path('/content/drive/MyDrive/roop-new/models/Frame/deoldify_artistic.onnx')
            elif self.prev_type == "deoldify_stable":
                model_path = resolve_relative_path('/content/drive/MyDrive/roop-new/models/Frame/deoldify_stable.onnx')
