    ...
    def Initialize(self, plugin_options:dict):
        ...
        if self.model_upscale is None:
            ...
            if self.prev_type == "esrganx4":
                model_path = resolve_relative_path('/content/drive/MyDrive/roop-new/models/Frame/real_esrgan_x4.onnx')
                self.scale = 4
            elif self.prev_type == "esrganx2":
                model_path = resolve_relative_path('/content/drive/MyDrive/roop-new/models/Frame/real_esrgan_x2.onnx')
                self.scale = 2
            elif self.prev_type == "lsdirx4":
                model_path = resolve_relative_path('/content/drive/MyDrive/roop-new/models/Frame/lsdir_x4.onnx')
                self.scale = 4
